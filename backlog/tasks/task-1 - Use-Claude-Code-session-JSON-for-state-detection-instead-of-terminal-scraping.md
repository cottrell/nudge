...
Example observed:
  PID 2347159, status: busy, cwd: ~/dev/nudge
  PID 1384688, status: idle, cwd: ~/dev/planner
...
agent-monitor (https://github.com/wesm/agent-monitor) was evaluated as a potential source
