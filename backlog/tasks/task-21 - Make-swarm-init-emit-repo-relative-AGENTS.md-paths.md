...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Generated swarm block does not contain ~ or any user-specific home path.
...
Swarm init and repo AGENTS now emit relative CLI/helper paths instead of ~-specific paths. Added regression coverage for the generated block and init output.
