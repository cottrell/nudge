...
- [ ] #3 CLI help and output messages match the action (stop says something about disabling prompts, not 'Started comms')
- [ ] #4 All tests pass; the dispatch test is updated to match new function names
- [ ] #5 self-awareness.txt and README reflect the new control commands
