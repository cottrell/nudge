...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Bare aiswarm (no subcommand) prints a short common-workflow cheat sheet, not an argparse error
- [x] #2 aiswarm instructions lists available guides (index)
- [x] #3 aiswarm instructions overview covers when/how to use swarm: start/stop, send vs backlog vs attach, babysit vs tasks, do-not raw send-keys
- [x] #4 At least one deeper guide exists (e.g. handoff and/or tasks); content can start from backlog doc-2 / README
- [x] #5 AGENTS.md AISWARM block can stay short or point at aiswarm instructions (no requirement to delete self-awareness runtime map)
- [x] #6 Command help (aiswarm <cmd> --help) remains for flags; instructions are workflow, not flag docs
<!-- AC:END -->
...
Bare aiswarm prints workflow cheat sheet; aiswarm instructions index + overview/handoff/tasks guides in swarm/instructions.py. AGENTS AISWARM block points at instructions. Flag help unchanged. 46 tests pass.
