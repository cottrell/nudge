...
> [!WARNING]
> You should probably just use [swarmesh](https://github.com/user/swarmesh) unless you really want these watchers, which rely on fragile state detection logic that is prone to false positives and breakage across agent CLI updates.
