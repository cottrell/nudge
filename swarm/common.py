...
def get_swarm_agent-monitor_report(agents: list[str] | None = None) -> dict:
    ...
    today_data = get_agent-monitor_usage_summary(agents=filter_for_api, since=today, until=today)
    week_data = get_agent-monitor_usage_summary(agents=filter_for_api, since=week_ago, until=today)
    ...
    return {
        ...
        "recent": get_agent-monitor_recent_tokens(10, agents=wanted or []),
    }
